...
export default function HomePages() {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-between">
      <h3 className="text-[#686868] text-2xl">
        Secure task and project management for team
      </h3>
      <h2 className="text-[#686868] text-6xl">
        <span className="text-black">Heureux</span> with your work
      </h2>
      <CustButtom
        content="Continue with Google"
        newClassName={
          " w-[18rem] h-[3rem] text-nowrap font-normal px-[20%]  text-white rounded-full"
        }
        fIcon={Ggsvg}
      ...
      <img
        src={homePagesImg}
        className="w-[80%] -translate-x-2 pointer-events-none"
      />
    </div>
  );
}
